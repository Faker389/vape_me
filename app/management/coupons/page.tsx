    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="flex justify-center gap-4 mb-8">
          ...
          >
            <Percent className={`w-6 h-6 ${viewMode === "add-discount" ? "text-white" : "text-white/60"}`} />
          ...
          >
            <Package className={`w-6 h-6 ${viewMode === "add-item" ? "text-white" : "text-white/60"}`} />
            <div className="text-left">
          ...
          >
            <List className={`w-6 h-6 ${viewMode === "manage" ? "text-white" : "text-white/60"}`} />
            <div className="text-left">
              <h3 className="text-lg font-bold text-white">Dostępne Kupony</h3>
        ...
        <div className="max-w-3xl mx-auto">
          <AnimatePresence mode="wait">
            {isOnline?viewMode=="add-discount"?<DiscountForm fkc={setShowSuccess} />:viewMode=="add-item"?<CouponForm fkc={setShowSuccess} />:<CouponList />:""}
          </AnimatePresence>
        </div>
